...
?>
      ...
      <?php endforeach; ?>
      <div class="container">
        <!-- HERO SECTION--><section class="py-5"  style="background-image: url('https://store.sirclo.com/blog/wp-content/uploads/2022/12/beautiful-asian-woman-carrying-colorful-bags-shopping-online-with-mobile-phone_8087-3877.jpg'); background-size: cover; background-position: center;">
          <div class="container">
          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="row mb-3 align-items-center">
                ...
                </div><h5 class="text-uppercase mb-4" style="color: #379392;">Kategori</h5>
