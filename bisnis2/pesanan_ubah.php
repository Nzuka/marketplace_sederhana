              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row gy-3">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="date" name="tgl_dikemas" id="tgl_dikemas" required value="<?= $pesanan["tgl_dikemas"]; ?>">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="tgl_dikirim">Tanggal Dikirim </label>
                    <input class="form-control form-control-lg" type="date" name="tgl_dikirim" id="tgl_dikirim" value="<?= $pesanan["tgl_dikirim"]; ?>">
                  </div>
                  <div class="col-lg-6">
