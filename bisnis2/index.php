...
$produk = query("SELECT * FROM produk ORDER BY id_produk DESC LIMIT 8");
...
?>    
    ...
    <div>
              ...
              <div class="row align-items-stretch">
                ...
                <div class="col-lg-6">
                  <div class="p-4 my-md-4">
                    ...
                    </div><a class="btn btn-link text-dark text-decoration-none p-0" href="#!"><i class="far fa-heart me-2"></i>Keranjang</a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container ">
          ...
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6 m-3" >
                ...
                <h1 class="h2 text-uppercase mb-3">DISKON MURAH MERIAH</h1><a class="btn btn-dark" href="shop.html">Ceckout sekarang!</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="py-5">
          <header>
            <p class="small text-muted small text-uppercase mb-1">Produk Terbaru!</p>
            <h2 class="h5 text-uppercase mb-4">Dapatkan Produk Kesayangan Anda!</h2>
          </header>
    <div class="row">
      <!-- PRODUCT--> 
      <?php
                    ...
                    if($_SESSION['user_type'] == 'admin'){
                        $user = mysqli_query($conn, "SELECT * FROM produk");
                    } else {
                        $user = mysqli_query($conn, "SELECT * FROM produk $where_id");
                    }
                    if ($user) {
                        $i = 1;
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
          <div class="product text-center">
            <div class="position-relative mb-3">
              ...
              <img class="img-fluid w-100" src="../img/<?php echo $row['foto_produk']; ?>" alt=""></a>
